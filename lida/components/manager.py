...
class Manager(object):
    def __init__(self, text_gen: TextGenerator = None) -> None:
        ...
        self.text_gen = llm(provider="openai", api_type="azure", api_base=os.environ["AZURE_OPENAI_BASE"],
                       api_key=os.environ["AZURE_OPENAI_API_KEY"], api_version=os.environ["AZURE_OPENAI_VERSION"])  # for azure openai
